...
<head>
    ...
    <meta name="description" content="Helcious PoS">
    <meta name="author" content="Helcious">
...
<body>
<img src="<?php echo base_url().'assets/img/bgmuliabaja.jpg'?>" alt="gambar" class="bg" />
    <!-- Navigation -->
   <?php 
	...
	<div class="mainbody-section text-center">
     ...
     <?php $u=$this->session->userdata('user'); ?>
            ...
            <div class="col-md-3 portfolio-item">
                <div class="menu-item blue" style="height:170px;">
                     <a href="<?php echo base_url().'admin/penjualan'?>" data-toggle="modal">
                           <i class="fa fa-shopping-bag"></i><p class>Penjualan Eceran</p>
                ...
                <div class="menu-item green" style="height:170px;">
                     <a href="<?php echo base_url().'admin/penjualan_grosir'?>" data-toggle="modal">
                           <i class="fa fa-cubes"></i>
                            <p class>Penjualan Grosir</p>
                      </a>
                </div> 
            </div>
            <div class="col-md-3 portfolio-item">
                <div class="menu-item light-orange" style="height:170px;">
        ...
        <?php if($h=='1'){ ?> 
            ...
            <div class="col-md-3 portfolio-item">
                <div class="menu-item light-red" style="height:170px;">
